...
export default function Chat({ initialMessages, id, isMobile }: ChatProps) {
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Lakukan retrieval dari Pinecone sebelum mengirim pesan ke API chat
    ...
    try {
      ...
      retrievedContent = data.results.join("\n");
    } catch (error) {
    ...
    const requestOptions: ChatRequestOptions = {
      body: {
        ...
        retrievedContent: retrievedContent, // Menyisipkan hasil retrieval ke request API
      },
      ...(base64Images && {
        data: {
          images: base64Images,
